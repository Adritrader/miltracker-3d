      ...
      try {
        const pinE = ds.entities.add({
          ...
          billboard: {
            ...
            scaleByDistance: new Cesium.NearFarScalar(1e5, 1.4, 1.5e7, 0.3),
          ...
          label: {
            ...
            scaleByDistance: new Cesium.NearFarScalar(1e5, 1.2, 1.2e7, 0.15),
          },
        });
      ...
      try {
        const entity = ds.entities.add({
          ...
          billboard: {
            ...
            verticalOrigin: Cesium.VerticalOrigin.BOTTOM,
            disableDepthTestDistance: 2e6,
            scaleByDistance: new Cesium.NearFarScalar(1e5, 1.3, 1e7, 0.4),
          },
        });
