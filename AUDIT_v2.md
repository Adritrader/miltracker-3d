...
| 🟡 Frontend — Medios | 12 | 14 | **86%** | `█████████████████░░░` |
| 🟢 Frontend — Bajos | 4 | 17 | **24%** | `█████░░░░░░░░░░░░░░░` |
| 🔴 Infra — Críticos | 0 | 3 | **0%** | `░░░░░░░░░░░░░░░░░░░░` |
| 🟠 Infra — Altos | 1 | 5 | **20%** | `████░░░░░░░░░░░░░░░░` |
| 🟡 Infra — Medios | 0 | 4 | **0%** | `░░░░░░░░░░░░░░░░░░░░` |
| 🟢 Infra — Bajos | 0 | 3 | **0%** | `░░░░░░░░░░░░░░░░░░░░` |
| 💰 Monetización | 2 | 13 | **15%** | `███░░░░░░░░░░░░░░░░░` |
| **🎯 TOTAL GLOBAL** | **50** | **115** | **43%** | `█████████░░░░░░░░░░░` |
...
- [x] **F-M2 · News ticker animation perf** ✅ *fix: `animation-play-state: paused` al expandir + keyframe usa `transform: translateX()` + `will-change: transform` → animación 100% en GPU, sin layout reflow* — `NewsPanel.jsx` ~L83: `animationPlayState` causa reflow en cada expand/collapse.
...
- [x] **F-M6 · Sin request limits en imagery tiles** ✅ *fix: `maximumRequestsPerServer: 4` añadido a todos los `new Cesium.ImageryLayer(...)` en `Globe3D.jsx` — limita peticiones concurrentes y evita que el tile queue bloquee el render en redes lentas* — `Globe3D.jsx` ~L140: Sin `maximumRequestsPerServer` → tiles bloquean en redes lentas.
...
- [x] **F-L17 · useTimeline historyTrack crece indefinidamente** ✅ *fix: `MAX_TRAIL_PTS = 60` — después de cada push, `.splice(0, length - 60)` para mantener solo los últimos 60 puntos por entidad, tanto en rebuild completo como en modo incremental* — Sin purge de datos antiguos en el historial de trail.
